function init() {
    const errorMessages = {
        ...
        email: {
            ...
            patternMismatch: "El formato debe ser ejemplo@dominio.com",
        },
        name: {
            valueMissing: "Este campo no puede ir vacío",
        ...
        password: {
            valueMissing: "Este campo no puede ir vacío",
            tooShort: "La contraseña debe tener mínimo 8 y máximo 12 dígitos",
        },
    };

    setupForm("search-user-form", errorMessages);
    setupForm("insert-user-form", errorMessages);
    setupForm("update-user-form", errorMessages);
}
